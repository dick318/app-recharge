<template>
  <div class="TotalContentBox">
    <div
      class="weui-panel weui-panel_access top-info"
      v-if='!otherAid'
    >
      <div class="weui-panel__bd top-info-content">
        <div class="weui-media-box weui-media-box_appmsg top-info-content">
          <div class="weui-media-box__hd logo_img">
            <img
              class="weui-media-box__thumb headimgurl"
    ...
    <div
      class="weui-panel weui-panel_access top-info zhh"
      v-if='otherAid'
    >
      <div class="weui-panel__bd top-info-content">
        <div class="weui-media-box weui-media-box_appmsg top-info-content">
    ...
    <div class="weui-grids weui-panel">
      <div
        class="weui-grid js_grid detail"
        @click="info"
        v-show="aid!=2886"
      >
      ...
      <div
        class="weui-grid js_grid record"
        @click="record"
      >
        <div class="weui-grid__icon ">
      ...
      <div
        class="weui-grid js_grid register"
        @click="clickStatus"
      >
        <div class="weui-grid__icon">
      ...
      <div
        class="weui-grid js_grid recharge"
        @click="recharge"
        v-show="aid == null||aid=='null'"
      >
        <div class="weui-grid__icon">
      ...
      <div
        class="weui-grid js_grid password"
        @click="password"
      >
        <div class="weui-grid__icon">
    ...
    <div
      ...
      @click="showMore"
    >
      <div class="weui-cell__bd">{{showMoreStatus==true?'收起':'查看更多'}} <img
          src="../img/arrow.png"
          alt=""
    ...
    <div
      class="weui-panel weui-panel_access addEvent"
      v-if="id == 50"
    >
      <div class="hengxian">
      </div>
