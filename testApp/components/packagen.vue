  ...
  <div class="weui-tab body-margin">
    <div class="weui-navbar">
      ...
      >
        {{ item.title }}
        <hr
          class="active_hengxian"
          v-bind:class="[item.active==true?'':'hidden' ]"
        >
      </div>
    </div>
    <div
        ...
        <div class="weui-panel weui-panel_access margin">
          ...
          >
            ...
            >
              ...
              <div
                class="choose "
                v-bind:class="[tab1.active==true ? '' : 'hidden']"
              >
                <img
                  src="../img/check.png"
                  alt=""
...
export default {
  ...
  beforeCreate: function() {
    ...
    //显示30天
    const lid_next = [22, 23, 24, 31, 32, 33, 34];
    const package_next = [1, 2, 4, 6, 7];
    //月套餐不显示时间
    ...
    //套餐分类，电信30元无限量套餐
    const type =
      c.contains(lid_next, +lid) ||
      lid == 24 ||
      c.contains(package_next, +package_type);
    ...
    function loadFlow(data) {
      ...
      if (c.contains(lid_add, +lid) || package_type == 3) {
